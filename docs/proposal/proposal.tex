...
\author{Group 9\\
Sameer Suleman, Yax Patel, Vaibhav Gopalakrishnan, Siddh Patel\\
Supervisor: Dr. Shirani}
\maketitle
...
The system divides into four modules, each with one member accountable for
delivering it. Ownership is not exclusivity: every module names supporting members
who contribute to it, and the tasks that cross a module boundary, such as bringing
up the fabric on real boards, are jointly executed. The owner is the person who
answers for the deliverable, not the only person who touches it. Modules remain
...
\subsection{Module A: Agentic Generation and Signoff}
\emph{Owner: Sameer. Support: Yax on the multi-agent architecture, Siddh on generated testbenches.}
...
\subsection{Module B: Interconnect Fabric and Collectives}
\emph{Owner: Yax. Support: Vaibhav on hardware bring-up of the link, Sameer on the profile interface.}
...
\subsection{Module C: Physical Implementation}
\emph{Owner: Vaibhav. Support: Siddh on board acceptance testing, Sameer on feeding post-route data back to the agents.}
...
\subsection{Module D: Verification and Physical Link}
\emph{Owner: Siddh. Support: Vaibhav on link fabrication and measurement, Yax on fabric-level test cases.}
...
\begin{ganttchart}[
  ...
  \ganttbar[bar/.append style={fill=teal!60}]{LLM iteration, multi-role agents}{8}{14} \\
  \ganttbar[bar/.append style={fill=teal!60}]{Agent-written testbenches}{13}{19} \\
  ...
  \ganttbar[bar/.append style={fill=teal!60}]{Two-board framing bring-up}{11}{16} \\
  \ganttbar[bar/.append style={fill=teal!60}]{Ring all-reduce on hardware}{14}{19} \\
  ...
  \ganttbar[bar/.append style={fill=teal!60}]{Post-route data into the profile}{7}{12} \\
  \ganttbar{Second board bring-up}{11}{15} \\
  \ganttbar[bar/.append style={fill=teal!60}]{Multi-board deployment}{16}{21} \\
  ...
  \ganttbar[bar/.append style={fill=teal!60}]{Link build and measurement}{10}{15} \\
  \ganttbar[bar/.append style={fill=teal!60}]{Coverage instrumentation}{14}{20} \\
  \ganttbar{Formal proofs}{18}{24} \\
  \ganttbar{Release verification}{23}{26} \\
  \ganttgroup{Continuous and shared}{1}{28} \\
  \ganttbar[bar/.append style={fill=teal!60}]{Bi-weekly reviews, documentation}{1}{28} \\
  \ganttbar[bar/.append style={fill=teal!60}]{Integration testing}{6}{27} \\
  \ganttbar[bar/.append style={fill=teal!60}]{Float and contingency}{24}{28} \\
  \ganttbar[bar/.append style={fill=teal!60}]{Final report and demonstration}{25}{28} \\
...
continuously from week~6. Teal bars are jointly executed by two or more members, which is where the module
interfaces meet. Diamonds mark the deliverable tiers.}
\label{fig:gantt}
\end{figure*}
